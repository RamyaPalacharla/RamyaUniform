Feature: Catalog
  ...
  Background: Open browser and navigate to url and login with admin credentials 
  	Given Open Browser and navigate to "http://uniformm1.upskills.in/admin/" url
    And Login with admin creditials "admin" and "admin@123"
