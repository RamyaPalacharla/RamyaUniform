...
public class StepDefinitions extends Base
{
	...
	@And("^Login with user creditials \"([^\"]*)\" and \"([^\"]*)\"$")
    public void login_with_user_creditials_something_and_something(String strArg1, String strArg2) throws Throwable
	{
    ...
    public void open_browser_and_navigate_to_something_url(String strArg1) throws Throwable 
    {
    	//opening browser
    	driver =initializeDriver();
    ...
    @And("^Login with admin creditials \"([^\"]*)\" and \"([^\"]*)\"$")
    public void login_with_admin_creditials_something_and_something(String strArg1, String strArg2) throws Throwable 
    {
